...
class Api:
    ...
    def getPosition(self, jid):
        ...
        url = "http://" + serverIP + "/asteroide-get.php?id=" + jid
    ...
    def postPosition(self, j, jid):
        ...
        url = "http://" + serverIP + "/asteroide-post.php"
    ...
    def tirerBalle(self, jid, x, y, rt):
        ...
        url = "http://" + serverIP + "/asteroide-get.php?tirer=" + str(jid) + "&x=" + str(x) + "&y=" + str(y) + "&a=" + str(rt)
        requests.get(url)
    ...
    def creerPartie(self):
        ...
        return requests.get("http://" + serverIP + "/asteroide-get.php?createGame=1").text

    def rejoindrePartie(self, idj):
        # Cette fonction permet d'ajouter un joueur à la base de données grâce à une id de partie
        return requests.get("http://" + serverIP + "/asteroide-get.php?joinGame=" + str(idj)).text

    def quitterPartie(self, idj):
        # Cette fonction permet de retirer le joeur de la base de données
        requests.get("http://" + serverIP + "/asteroide-get.php?quitGame=" + idj)

    def ecrireConf(self, multij, jip, jid):
    ...
    def writeScore(self, nom, pts, multij):
